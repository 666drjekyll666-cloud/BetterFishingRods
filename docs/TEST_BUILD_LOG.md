...
| Visual Prototype 0.2.0 | pending | `research/fishing-visual` | Full-wait in-world countdown ring only; no gameplay changes | Perform several normal casts; judge position/size/visibility/timing/motion; return screenshot/video only if alignment is wrong | Build pending |
